...
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports {clk50mhz}]; #IO_L11P_T1_SRCC_35 Sch=sysclk
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports {clk50mhz}];
...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L18N_T2_34 Sch=JE2
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_25_35 Sch=JE3
...
# Salidas VGA RGB (16 bits: 5R + 6G + 5B) mapeadas a pines VGA
set_property -dict { PACKAGE_PIN M19 IOSTANDARD LVCMOS33 } [get_ports { rgb[15] }]  ;# R4
set_property -dict { PACKAGE_PIN L20 IOSTANDARD LVCMOS33 } [get_ports { rgb[14] }]  ;# R3
set_property -dict { PACKAGE_PIN J20 IOSTANDARD LVCMOS33 } [get_ports { rgb[13] }]  ;# R2
set_property -dict { PACKAGE_PIN G20 IOSTANDARD LVCMOS33 } [get_ports { rgb[12] }]  ;# R1
set_property -dict { PACKAGE_PIN F19 IOSTANDARD LVCMOS33 } [get_ports { rgb[11] }]  ;# R0

set_property -dict { PACKAGE_PIN H18 IOSTANDARD LVCMOS33 } [get_ports { rgb[10] }]  ;# G5
set_property -dict { PACKAGE_PIN N20 IOSTANDARD LVCMOS33 } [get_ports { rgb[9] }]   ;# G4
set_property -dict { PACKAGE_PIN L19 IOSTANDARD LVCMOS33 } [get_ports { rgb[8] }]   ;# G3
set_property -dict { PACKAGE_PIN J19 IOSTANDARD LVCMOS33 } [get_ports { rgb[7] }]   ;# G2
set_property -dict { PACKAGE_PIN H20 IOSTANDARD LVCMOS33 } [get_ports { rgb[6] }]   ;# G1
set_property -dict { PACKAGE_PIN F20 IOSTANDARD LVCMOS33 } [get_ports { rgb[5] }]   ;# G0

set_property -dict { PACKAGE_PIN P20 IOSTANDARD LVCMOS33 } [get_ports { rgb[4] }]   ;# B4
set_property -dict { PACKAGE_PIN M20 IOSTANDARD LVCMOS33 } [get_ports { rgb[3] }]   ;# B3
set_property -dict { PACKAGE_PIN K19 IOSTANDARD LVCMOS33 } [get_ports { rgb[2] }]   ;# B2
set_property -dict { PACKAGE_PIN J18 IOSTANDARD LVCMOS33 } [get_ports { rgb[1] }]   ;# B1
set_property -dict { PACKAGE_PIN G19 IOSTANDARD LVCMOS33 } [get_ports { rgb[0] }]   ;# B0

# Señales de sincronización VGA
